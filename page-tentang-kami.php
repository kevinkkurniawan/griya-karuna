...
<section style="padding: 40px 0 60px;">
	<div class="container" style="display: grid; grid-template-columns: 1fr 1fr; gap: 48px; align-items: center;">
		...
		<div>
			<img src="https://images.unsplash.com/photo-1576091160399-112ba8d25d1d?q=80&w=1000&auto=format&fit=crop" alt="Mengenal Griya Karuna" style="border-radius: var(--border-radius-card); width: 100%; height: 420px; object-fit: cover; box-shadow: var(--shadow-md);" />
		</div>
	</div>
</section>

<!-- Banner Visi Kami -->
<section style="position: relative; background-color: var(--color-accent); padding: 60px 0; color: var(--color-primary); text-align: center;">
	<div class="container" style="max-width: 860px;">
		<h2 style="font-size: 2.2rem; font-weight: 700; color: #FFFFFF; margin-bottom: 20px; text-shadow: 0 2px 8px rgba(0,0,0,0.15);">Visi Kami</h2>
		<p style="font-size: 1.15rem; color: #FFFFFF; line-height: 1.75; font-weight: 500;">
...
<section style="padding: 80px 0; background-color: #FFFFFF;">
	<div class="container" style="max-width: 960px;">
		<h2 style="font-size: 2.2rem; font-weight: 700; color: var(--color-primary); text-align: center; margin-bottom: 48px;">Misi Kami</h2>
		
		<div style="display: grid; grid-template-columns: 1fr 1fr; gap: 32px 48px;">
			<div style="display: flex; gap: 16px; align-items: flex-start;">
				<div style="width: 28px; height: 28px; border-radius: 50%; background: var(--color-accent); display: flex; align-items: center; justify-content: center; flex-shrink: 0; margin-top: 2px;">
				...
				<p style="font-size: 1.05rem; color: var(--color-text-muted); line-height: 1.6;">Menyediakan tempat tinggal sementara yang layak dan ramah anak</p>
			</div>
			...
			<div style="display: flex; gap: 16px; align-items: flex-start;">
				...
				<p style="font-size: 1.05rem; color: var(--color-text-muted); line-height: 1.6;">Menjalin kerja sama dengan instansi pemerintah, lembaga sosial dan masyarakat untuk memperluas jangkauan dan dampak program</p>
			</div>
			...
			<div style="display: flex; gap: 16px; align-items: flex-start;">
				...
				<p style="font-size: 1.05rem; color: var(--color-text-muted); line-height: 1.6;">Menciptakan lingkungan yang aman dan penuh empati</p>
			</div>
			...
			<div style="display: flex; gap: 16px; align-items: flex-start;">
				...
				<p style="font-size: 1.05rem; color: var(--color-text-muted); line-height: 1.6;">Membangun komunitas yang inklusif dan berempati, yang mendorong para penghuni pasien anak dan pendampingnya untuk bangkit dan berdiri</p>
			</div>
			...
			<div style="display: flex; gap: 16px; align-items: flex-start;">
				...
				<p style="font-size: 1.05rem; color: var(--color-text-muted); line-height: 1.6;">Menyediakan akses informasi dan pendampingan untuk mendapatkan layanan kesehatan</p>
			</div>
		</div>
	</div>
</section>
